...
var http_client = Object.create(null, {
    ...
    server_statistic: { value: () => {
        return chai.request(app).get('/').end((error, response) => {
            return {
    ...
    // }
    msg: { value: (request) => {
        return chai.request(app).post('/msg').send(request).end((error, response) => {
            return {
                statusCode: response.res.statusCode,
                response: response.res,
                error: error
    ...
    // /ping	// maps to /msg
    ping: { value: () => {
        return chai.request(app).get('/ping').end((error, response) => {
            done();
            return {
                statusCode: response.res.statusCode,
                response: response.res,
    ...
    people_get: { value: () => {
        return chai.request(app).get('/people').end((error, response) => {
            return {
                statusCode: response.res.statusCode,
                response: response.res,
                error: error
    ...
    people_post: { value: (request) => {
        return chai.request(app).post('/people').send(request).end((error, response) => {
            return {
                statusCode: response.res.statusCode,
                response: response.res,
                error: error
    ...
    contract: { value: (contract_id) => {
        return chai.request(app).get('/contract?' + contract_id).end((error, response) => {
            return {
                statusCode: response.res.statusCode,
                response: response.res,
                error: error
    ...
    project: { value: (project_id) => {
        return chai.request(app).get('/project?' + project_id).end((error, response) => {
            return {
                statusCode: response.res.statusCode,
                response: response.res,
                error: error
